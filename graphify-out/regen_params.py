...
STAGE_PARAMS = {
    'p1_a_detect': [
        ...
        ('--imgsz',         1920,           'size',      None,  'Inference image size (1920 default for puck recall)'),
    ...
    'p1_b_teams': [
        ...
        ('--team-engine',   'hsv',          'engine',    'choice', 'Single-engine backend (legacy)', ['hsv','osnet','siglip','contrastive']),
        ('--team-engines',  None,           'engine',    None,  'Multi-engine: comma-separated list, e.g. contrastive,hsv'),
    ...
    'p1_c_numbers': [
        ...
        ('--pose-cache',    '<dir>/p1_pose_cache.pkl', 'speed', None, 'Read pose from cache'),
        ('--teams-json',    '<dir>/p1_b_teams.json','io',None, 'Stage 1.b output (team-aware OCR namespacing)'),
    ...
    'p3_a_entities': [
        ...
        ('--samples-per-track', 15,         'size',      None,  'Embeddings per track (default 15, was 8)'),
        ...
        ('--ocr-conflict-conf-floor', 0.40, 'threshold', None,  'Conflict gate (team-aware)'),
        ('--goalie-bonus',  0.05,           'threshold', None,  ''),
        ('--team-conf-floor', 0.50,         'threshold', None,  'Soft floor (was 0.67 hard)'),
        ('--max-overlap-frames', 2,         'threshold', None,  'Tolerate ≤2 frames overlap (was 0)'),
        ('--cross-team-penalty', 0.30,      'threshold', None,  'Soft same-team penalty (was hard reject)'),
...
ORCHESTRATOR = {
    ...
    'params': [
        ...
        ('--imgsz',         1920,           'size',      None,  '→ Stage 1.a (1920 default, was 1280)'),
        ('--tracker',       'bytetrack.yaml','tracker',  None,  '→ Stage 1.a'),
        ('--pose-model',    'yolo26l-pose.pt','model',   None,  '→ Pose pre-extract + 1.b + 1.c'),
        ('--team-engine',   'hsv',          'engine',    'choice','→ Stage 1.b (single)', ['hsv','osnet','siglip','contrastive']),
        ('--team-engines',  None,           'engine',    None,  '→ Stage 1.b (multi-engine list)'),
